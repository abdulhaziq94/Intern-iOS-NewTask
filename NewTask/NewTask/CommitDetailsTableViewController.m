//
//  CommitDetailsTableViewController.m
//  NewTask
//
...
@interface CommitDetailsTableViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
    ...
    CommitDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:commitIdentifier forIndexPath:indexPath];
    
        long i = indexPath.row;
        CommitObject *committer  = [self.CommitDetailArray objectAtIndex:i];
        cell.CommitMessageLabel.text = committer.commitMessage;
